...
def pump_rate():
     with st.form('caudales', clear_on_submit=True):
        ...
        q1 = st.number_input("Caudal 1 (gpm) :red[*]: ",value=None,placeholder="Type a number...")
        ...
        cb = st.number_input("capacidad de la bomba (bbl/stk): ",value=None,placeholder="Type a number...")
